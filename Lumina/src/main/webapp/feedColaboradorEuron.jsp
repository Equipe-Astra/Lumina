						...
						<div class="d-flex justify-content-start flex-column">
							...
							<div class="perfil-mobile mt-1">
								...
								<div
									...
									<p class="fw-medium cargo text-grey mt-1 mb-0">Colaborador Euron</p>
								</div>
							</div>
				...
				<div class="sidebar">
					<div
						...
						<div
							...
							<p class="fw-medium mb-0 color-gradient text-uppercase">${nome}</p>
							<p class="fw-medium cargo text-grey mt-2">Colaborador Euron</p>
						</div>
						<section
			...
			<div
				...
				<div id="feedContainer" class="scrollable-cards w-100 p-3">
		          ...
		          <nav class="navbar navbar-light bg-white shadow ps-3 pe-3 navbar-bottom d-flex fixed d-flex justify-content-around align-items-center">
                    <a href="/Lumina/feedColaboradorEuron" class="text-center text-decoration-none text-primary">
